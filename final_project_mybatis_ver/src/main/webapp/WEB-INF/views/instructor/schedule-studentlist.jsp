...
<body>
	...
	<div id="right-panel" class="right-panel">
				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li><a href="${pageContext.request.contextPath}/instructor/schedule">View Schedule</a></li>
							...
							<div class="card-body">
								<table id=""
									...
									<tbody>
										...
										<c:forEach var ="s" items="${studentSearch}">
										<tr>
											<td>${s.name_}</td>
											<td>${s.phone}</td>
											<td><df:dateForm date="${s.initial_reg_date}"/></td>
											<td>${s.learning_status }</td>
											<td><df:dateForm date="${s.course_end_date}"/></td>
										</tr>
										</c:forEach>
										</c:if>
										<c:if test="${studentCount==0}">
										<tr><td colspan="5">There is no student.</td></tr>
										</c:if>
									</tbody>
								</table>
							</div>
		...
		<!-- Modal -->
		<div class="modal fade" id="score-setting" role="dialog">
			<div class="modal-dialog">

				<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title">Score Input</h4>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<div class="modal-body">


						<div class="form-group"><label for="attendance-percentage" class=" form-control-label">Attendance Score</label>
						<input type="text" id="attendance-percentage" name="attendance-percentage" placeholder="Please type in the score(max 20)" class="form-control"></div>
						<div class="form-group"><label for="writing-percentage" class=" form-control-label">Writing Score</label>
						<input type="text" id="writing-percentage" name="writing-percentage" placeholder="Please type in the score(max 40)" class="form-control"></div>
						<div class="form-group"><label for="practice-percentage" class=" form-control-label">Practice Score</label>
						<input type="text" id="practice-percentage" name="practice-percentage" placeholder="Please type in the score(max 40)" class="form-control"></div>



					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-info btn-total-percentage">OK</button>
