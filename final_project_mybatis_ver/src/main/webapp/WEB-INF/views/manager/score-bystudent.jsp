				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li>View Score</li>
							<li class="active">Score by Student</li>
						</ol>
					</div>
				</div>
			</div>
											...
											<tbody>
												...
												<c:forEach var="s" items="${studentList}">
													...
													<tr>
														...
														<td><a href="${pageContext.request.contextPath}/manager/score/bystudent/courselist?student_id=${s.student_id}"><button type="button" class="btn btn-info btn-sm"><i class="fa fa-search"></i></button></a></td>
													</tr>
