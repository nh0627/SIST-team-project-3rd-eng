		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<!-- /.menu-title -->
					<li class="active"><a href="${pageContext.request.contextPath}/manager/main"> <i class="menu-icon fa fa-home"></i>Main
					</a></li>
			...
			<div class="animated fadeIn">
				<div class="row">
					...
					<div class="col-lg-5 col-md-6">
						<div class="card">
							<div class="card-header">
								<strong class="card-title mb-3">Manager Info</strong>
							</div>
							<div class="card-body">
								<div class="mx-auto d-block">
									<img class="rounded-circle mx-auto d-block"
										src="${pageContext.request.contextPath}/resources/uploads/pictures/${sessionScope.managerLoginInfo.profile_img}" alt="Card image cap">
									<h5 class="text-sm-center mt-2 mb-1">${sessionScope.managerLoginInfo.name_}</h5>
					...
					<div class="col-lg-7">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Manager Info</strong>
							</div>
							<div class="card-body">
