				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li><a href="${pageContext.request.contextPath}/manager/score/bystudent/courselist?student_id=${studentInfo.student_id}"> Course History</a></li>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">수강생 ${studentInfo.student_id}(${studentInfo.name_}/${studentInfo.ssn}) / ${oc_title}(${oc_date}) Score Sheet</strong>
							</div>
							<div class="card-body">
												...
												<tbody>
													...
													<tr>
														...
														<td><p class="tt instructor-profile">
															...
															강의가능과목<br> ${s.available_subjects}
															</span>
														</p>
													</td>
