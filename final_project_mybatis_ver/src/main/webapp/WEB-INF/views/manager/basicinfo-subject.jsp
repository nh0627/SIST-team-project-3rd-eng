...
<!-- <script type="text/javascript" src="${pageContext.request.contextPath}/https://cdn.jsdelivr.net/html5shiv/3.7.3/html5shiv.min.js"></script> -->

</head>
<script>
	$(document).ready(function() {
		$("button.btnDeleteSubject").on("click", function() {
			if (confirm("Would you like to delete the selected data?")) {
				var bs_id = $(this).val();
				location.assign("${pageContext.request.contextPath}/manager/basicinfo/subject/delete?bs_id=" + bs_id);
			}
		});
	});
</script>
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown show active">
                        ...
                        <ul class="sub-menu children dropdown-menu show">
                            ...
                            <li class="active"><i class="fa fa-table"></i><a href="${pageContext.request.contextPath}/manager/basicinfo/subject">Basic Subject</a></li>
	...
	<div id="right-panel" class="right-panel">
				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li><a
								href="#">Manage Basic Info</a></li>
							<li class="active">Basic Subject</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Registerred Baic Subject List</strong><button type="button" class="btn btn-info btn-sm btn-margin-left"
													data-toggle="modal" data-target="#addSubject">Add New</button>
							</div>
							<div class="card-body">
											...
											<table id="bootstrap-data-table"
												...
												<tbody>
													<c:forEach var="s" items="${bsList_ds}">
														<tr>
															<td>${s.bs_id}</td>
															<td>${s.bs_name}</td>
															<td><a href="#"><button type="button" class="btn btn-info btn-sm btnDeleteSubject" value="${s.bs_id}" ${(s.delete_status=='Y')?"":"disabled"}>Delete</button></a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
		...
		<div class="modal fade" id="addSubject" role="dialog">
			<div class="modal-dialog">
				...
				<form id="new insert" action="${pageContext.request.contextPath}/manager/basicinfo/subject/insert" method="POST" >
					<div class="modal-header">
						<h4 class="modal-title">Add New Basic Subject</h4>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="bs_name" class=" form-control-label">Subject Name</label> <input
								id="bs_name" name="bs_name" placeholder="Enter a subject name" class="form-control" required>
						</div>
