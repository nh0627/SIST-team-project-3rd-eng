		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<!-- /.menu-title -->
					<li class="active"><a href="${pageContext.request.contextPath}/student/main"> <i
							class="menu-icon fa fa-home"></i>Main
					</a></li>
					<li><a href="${pageContext.request.contextPath}/student/score"> <i
			...
			<div class="animated fadeIn">
				<div class="row">
					...
					<div class="col-lg-5 col-md-6">
						<div class="card">
							<div class="card-header">
								<strong class="card-title mb-3">Student Info</strong>
							</div>
							<div class="card-body">
								<div class="mx-auto d-block">
									<img class="rounded-circle mx-auto d-block"
										src="${pageContext.request.contextPath}/resources/uploads/pictures/${sessionScope.studentLoginInfo.profile_img}" alt="Card image cap">
									<h5 class="text-sm-center mt-2 mb-1">${sessionScope.studentLoginInfo.name_}</h5>
								...
								<table class="table table-striped table-bordered">
									<tbody>
										...
										<tr>
											...
											<td>
											<df:dateForm date="${initial_reg_date}"/></td>
										</tr>
										<tr>
											<th>Number of Reg. Courses</th>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Course History</strong>
							</div>
							<div class="card-body">
								<table id=""
									...
									<c:if test="${courseCount==0}">
										<tr>
											<td colspan="4">There is no course history.</td>
										</tr>
									</c:if>
									</tbody>
								</table>
